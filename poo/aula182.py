...
# Seu objetivo é uma instância da sua classe
...
#
# Métodos importates da metaclass
...
# não precisa (as coisas que realmente precisam delas sabem
...
class Meta(type):
    # __new__ cria e retorna a classe
    ...
    # __call__ cria e retorna a instância
    def __call__(self, *args, **kwds):
        instancia = super().__call__(*args, **kwds)
        
        if 'nome' not in instancia.__dict__:
            raise NotImplementedError('Crie o attr falar')
